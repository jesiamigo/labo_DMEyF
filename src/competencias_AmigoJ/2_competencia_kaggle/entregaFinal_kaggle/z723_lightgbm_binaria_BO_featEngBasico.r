...
PARAM$trainingstrategy$semilla_azar   <- 124739  #Aqui poner la propia semilla
...
PARAM$hyperparametertuning$semilla_azar  <- 954011 #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy
...
dir.create( "./exp/723_lightgbm_featEngBasico/",  showWarnings = FALSE ) 
dir.create( paste0( "./exp/723_lightgbm_featEngBasico/", PARAM$experimento, "/"), showWarnings = FALSE )
setwd( paste0( "./exp/723_lightgbm_featEngBasico/", PARAM$experimento, "/") )   #Establezco el Working Directory DEL EXPERIMENTO
