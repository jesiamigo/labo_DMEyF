...
PARAM  <- list()
PARAM$experimento <- "FE9250_competencia_4_v5"
...
AgregaVarRandomForest  <- function( num.trees, max.depth, min.node.size, mtry)
{
  ...
  dataset_rf[ , entrenamiento := as.integer( ((foto_mes>= 201907 &  foto_mes<= 201912) | (foto_mes>= 202101 &  foto_mes<= 202105)) & ( clase01==1 | azar < 0.10 )) ]
