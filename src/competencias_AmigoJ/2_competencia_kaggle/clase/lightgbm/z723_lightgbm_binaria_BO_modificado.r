...
PARAM$experimento  <- "HT7231_modificado_loops"

PARAM$input$dataset       <- "./datasets/competencia2_2022.csv.gz"
PARAM$input$training      <- c( 202103 )

PARAM$trainingstrategy$undersampling  <-  1.0   # un undersampling de 0.1  toma solo el 10% de los CONTINUA
PARAM$trainingstrategy$semilla_azar   <- 954011  #Aqui poner la propia semilla
...
PARAM$hyperparametertuning$semillas_azar  <- c(102191, 954011, 657863, 124739, 761213, 857957, 124769, 347621, 553229, 912349)  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy
