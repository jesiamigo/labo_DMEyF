...
PARAM  <- list()
PARAM$experimento <- "TS9320_competencia_4_v4"

PARAM$exp_input  <- "FE9250_competencia_4_v4"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 202101, 202102, 202103, 202104, 202105, 202106, 202107 )

PARAM$train$training     <- c( 201901, 201902, 201903, 201904, 201905, 201906, 201907 )
